...
export const loginStyles = {
  ...
  input: "w-full px-4 py-3 bg-[#23263a] text-white rounded-xl focus:ring-2 focus:ring-red-500 focus:outline-none border border-gray-700 placeholder-gray-400 text-base transition-all duration-200 mb-1",
  inputWithIcon: "w-full px-4 py-3 bg-[#23263a] text-white rounded-xl focus:ring-2 focus:ring-red-500 focus:outline-none border border-gray-700 pr-10 placeholder-gray-400 text-base transition-all duration-200 mb-1",
